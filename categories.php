		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table" id="manageCategoriesTable">
					<thead>
						<tr>
							<th style="width:10%">Tree ID</th>	
							<th style="width:12%">Category Code</th>	
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitCategoriesForm" action="php_action/createCategories.php" method="POST">
	      ...
	      <div class="modal-body">
			...
			<div class="form-group">
				<label for="categoriesParent" class="col-sm-4 control-label">Parent Category: </label>
	        	<label class="col-sm-1 control-label">: </label>
				<div class="col-sm-7">
					<select class="form-control" name="categoriesParent" id="categoriesParent">
						<option value="">~~SELECT~~</option>
						<?php
							$sql = "SELECT * FROM category WHERE level < 5 AND category_status != 3";
							$data = $connect->query($sql);

							while($row = $data->fetch_array()) {
								echo "<option value='".$row['id_category']."' id='parentId".$row['id_category']."'>".$row['tree_id']." : ".$row['category_name']."</option>";
								} // /while 
						?>
					</select>
				</div>
    	...
    	<form class="form-horizontal" id="editCategoriesForm" action="php_action/editCategories.php" method="POST">
	      ...
	      <div class="modal-body">
			...
			<div class="edit-categories-result">
		        ...
		        <div class="form-group">
					<label for="editCategoriesParent" class="col-sm-4 control-label">Parent Category: </label>
					<label class="col-sm-1 control-label">: </label>
					<div class="col-sm-7">
						<select class="form-control" name="editCategoriesParent" id="editCategoriesParent">
							<option value="">~~SELECT~~</option>
							<?php
								$sql = "SELECT * FROM category WHERE level < 5 AND category_status != 3";
								$data = $connect->query($sql);
